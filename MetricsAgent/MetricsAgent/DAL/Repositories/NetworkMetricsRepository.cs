...

{
    ...
    public class NetworkMetricsRepository : INetworkMetricsRepository
    {
        ...
        public IList<NetworkMetric> GetByTimePeriod(TimePeriod respond)
        {
            using var connection = new SQLiteConnection(ConnectionString);
            connection.Open();
            using var cmd = new SQLiteCommand(connection);
            ...
            cmd.CommandText = $"SELECT * FROM networkmetrics WHERE time BETWEEN {respond.fromTime} AND {respond.toTime}";
